...
namespace BeyondPixels.ECS.Systems.Items
{
    ...
    public class ModifyDefenceStatWithItemsSystem : JobComponentSystem
    {
        [BurstCompile]
        private struct ModifyStatJob : IJobForEachWithEntity<CharacterComponent, DefenceStatComponent>
        {
            [ReadOnly]
            ...
            [ReadOnly]
            public ArchetypeChunkComponentType<DefenceStatModifierComponent> ModifierStatComponentType;
            [ReadOnly]
                ...
                All = new ComponentType[]
{
        ...
        protected override JobHandle OnUpdate(JobHandle inputDeps)
        {
            ...
            return new ModifyStatJob
            {
                ...
                ModifierStatComponentType = this.GetArchetypeChunkComponentType<DefenceStatModifierComponent>(),
