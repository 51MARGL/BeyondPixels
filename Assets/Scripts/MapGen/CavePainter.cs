        ...
        switch (caseName) {
            ...
            case "wall":
                ...
                if (UnityEngine.Random.Range(0, 10) < 8 || y == 0) {
                    wall = Instantiate(wallPrefab, new Vector2(x, y), Quaternion.identity, transform);

                } else {
                    wall = Instantiate(wallGreenPrefab, new Vector2(x, y), Quaternion.identity, transform);
                }
                break;
            case "wallRight":
            ...
            case "wallDDownCornerLeft":
                GameObject wallDDownCornerLeft = Instantiate(wallDDownCornerLeftPrefab, new Vector2(x, y), Quaternion.identity, transform);
                break;
            case "wallDDownCornerRight":
                GameObject wallDDownCornerRight = Instantiate(wallDDownCornerRightPrefab, new Vector2(x, y), Quaternion.identity, transform);
                break;
            case "wallVoid":
                GameObject wallVoid;
                ...
                break;
            case "wallCornerLeft":
                GameObject wallCornerLeft;
                if (UnityEngine.Random.Range(0, 10) < 8) {
                    wallCornerLeft = Instantiate(wallCornerLeftPrefab, new Vector2(x, y), Quaternion.identity, transform);

                } else {
                    wallCornerLeft = Instantiate(wallCornerLeftGreenPrefab, new Vector2(x, y), Quaternion.identity, transform);
                }

                break;
            case "wallCornerRight":
                GameObject wallCornerRight;
                if (UnityEngine.Random.Range(0, 10) < 8) {
                    wallCornerRight = Instantiate(wallCornerRightPrefab, new Vector2(x, y), Quaternion.identity, transform);

                } else {
                    wallCornerRight = Instantiate(wallCornerRightGreenPrefab, new Vector2(x, y), Quaternion.identity, transform);
                }
                break;
            case "wallDown":
                GameObject wallDown = Instantiate(wallDownPrefab, new Vector2(x, y), Quaternion.identity, transform);
                break;
            case "wallDownCornerRight":
                GameObject wallDownCornerRight;
                if (UnityEngine.Random.Range(0, 10) < 8) {
                    wallDownCornerRight = Instantiate(wallDownCornerRightPrefab, new Vector2(x, y), Quaternion.identity, transform);
                } else {
                    wallDownCornerRight = Instantiate(wallDownCornerRightGreenPrefab, new Vector2(x, y), Quaternion.identity, transform);
                }
                break;
            case "wallDownCornerLeft":
                GameObject wallDownCornerLeft;
                if (UnityEngine.Random.Range(0, 10) < 8) {
                    wallDownCornerLeft = Instantiate(wallDownCornerLeftPrefab, new Vector2(x, y), Quaternion.identity, transform);

                } else {
                    wallDownCornerLeft = Instantiate(wallDownCornerLeftGreenPrefab, new Vector2(x, y), Quaternion.identity, transform);
                }
                break;
            case "floor":
                GameObject floor;
                if (UnityEngine.Random.Range(0, 10) < 4) {
                    floor = Instantiate(floorPrefab, new Vector2(x, y), Quaternion.Euler(Vector3.forward * 90 * (UnityEngine.Random.Range(0, 10) % 4)), transform);
                } else if (UnityEngine.Random.Range(0, 10) < 7) {
                    floor = Instantiate(floor2Prefab, new Vector2(x, y), Quaternion.Euler(Vector3.forward * 90 * (UnityEngine.Random.Range(0, 10) % 4)), transform);
                } else {
                    floor = Instantiate(floorGreenPrefab, new Vector2(x, y), Quaternion.Euler(Vector3.forward * 90 * (UnityEngine.Random.Range(0, 10) % 4)), transform);
                }
                break;
            default:
                break;
